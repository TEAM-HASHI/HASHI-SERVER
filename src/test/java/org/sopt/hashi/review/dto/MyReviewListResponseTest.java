...
class MyReviewListResponseTest {

    private final ObjectMapper objectMapper = new ObjectMapper();

    @Test
    void 마지막_페이지에서는_nextCursor를_응답에서_생략한다() throws Exception {
        MyReviewListResponse response = new MyReviewListResponse(List.of(), null, false);
    ...
    void 다음_페이지가_있으면_nextCursor를_응답에_포함한다() throws Exception {
        MyReviewListResponse response = new MyReviewListResponse(List.of(), 10L, true);
