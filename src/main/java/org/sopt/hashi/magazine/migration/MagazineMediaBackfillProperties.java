...
@ConfigurationProperties(prefix = "hashi.magazine.media-backfill")
public record MagazineMediaBackfillProperties(
        boolean enabled,
        String runId,
    ...
    public MagazineMediaBackfillProperties {
        Objects.requireNonNull(target, "magazine media backfill target is required");
        Objects.requireNonNull(mode, "magazine media backfill mode is required");
        Objects.requireNonNull(leaseDuration, "magazine media backfill lease duration is required");
        Objects.requireNonNull(retryInitialDelay, "magazine media backfill retry delay is required");
