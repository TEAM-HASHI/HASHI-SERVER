...
@Slf4j
class RestaurantMediaBackfillSourceFailures {

    static final String METRIC_NAME = "hashi.restaurant.media.backfill.source.failures";
    ...
    RestaurantMediaBackfillSourceFailures(
    ...
    void record(Reason reason) {
        ...
        try {
            ...
            log.warn("Restaurant backfill failure metric unavailable: target={}, mode={}, reason={}, errorType={}",
