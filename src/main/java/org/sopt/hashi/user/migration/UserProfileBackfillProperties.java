...
@ConfigurationProperties(prefix = "hashi.user.profile-backfill")
public record UserProfileBackfillProperties(
        boolean enabled,
        String runId,
    ...
    public UserProfileBackfillProperties {
        Objects.requireNonNull(mode, "user profile backfill mode is required");
        Objects.requireNonNull(leaseDuration, "user profile backfill lease duration is required");
        Objects.requireNonNull(retryInitialDelay, "user profile backfill retry delay is required");
